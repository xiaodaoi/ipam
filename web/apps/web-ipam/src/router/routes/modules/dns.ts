    ...
    children: [
      {
        ...
        meta: { icon: 'lucide:globe', title: $t('page.dns.upstream'), authority: ['dns:read'] },
      },
      {
        name: 'DnsForward',
        path: '/dns-service/forward',
        component: () => import('#/views/dns/forward/index.vue'),
        meta: { icon: 'lucide:route', title: $t('page.dns.forward'), authority: ['dns:read'] },
      },
      {
        name: 'DnsRecords',
        path: '/dns-service/records',
        component: () => import('#/views/dns/records/index.vue'),
        meta: { icon: 'lucide:book-open', title: $t('page.dns.records'), authority: ['dns:read'] },
      },
      {
        name: 'DnsCache',
        path: '/dns-service/cache',
        component: () => import('#/views/dns/cache/index.vue'),
        meta: { icon: 'lucide:gauge', title: $t('page.dns.cache'), authority: ['dns:read'] },
      },
      {
        name: 'DnsSecurity',
        path: '/dns-service/security',
        component: () => import('#/views/dns/security/index.vue'),
        meta: { icon: 'lucide:shield-check', title: $t('page.dns.security'), authority: ['dns:read'] },
      },
      {
        name: 'DnsBlocklist',
        path: '/dns-service/blocklist',
        component: () => import('#/views/dns/blocklist/index.vue'),
        meta: { icon: 'lucide:shield-ban', title: $t('page.dns.blocklist'), authority: ['dns:read'] },
      },
    ],
  },
];
